...
class User(Base):
    ...
    )  # 'super_admin', 'secretary', 'it_admin', 'servant'
    ...
    updated_contacts = relationship("Contact", foreign_keys="Contact.updated_by")
...
class Contact(Base):
    ...
    )  # e.g., 'active', 'inactive', 'lead', 'customer'
    ...
    creator = relationship(
        "User", foreign_keys=[created_by], back_populates="created_contacts"
    )
    updater = relationship(
        "User", foreign_keys=[updated_by], back_populates="updated_contacts"
    )
